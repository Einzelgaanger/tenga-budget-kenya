      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-8 md:mb-0 text-center md:text-left">
            <h3 className="font-bold text-2xl mb-2 bg-gradient-to-r from-brand-secondary to-accent-orange bg-clip-text text-transparent">
              Tenga Pesa
            </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8 md:gap-16 text-left">
            <div>
              <h4 className="font-semibold mb-4 text-accent-orange">Quick Links</h4>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-accent-orange">Information</h4>
              <ul className="space-y-2">
                <li>
                  <a href="#" className="text-gray-400 hover:text-accent-orange transition-colors flex items-center">
